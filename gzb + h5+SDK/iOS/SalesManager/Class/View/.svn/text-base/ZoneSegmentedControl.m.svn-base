//
//  NewsSegmentedControl.m
//  Club
//
//  Created by liu xueyan on 11/8/13.
//  Copyright (c) 2013 liu xueyan. All rights reserved.
//

#import "ZoneSegmentedControl.h"
#import <QuartzCore/QuartzCore.h>

@interface StainView : UIView
@end

@interface ZoneSegmentedControl ()
...
@implementation ZoneSegmentedControl{
...
- (void)commonInit
{
    ...
    self._selectedStainView.backgroundColor = [UIColor colorWithRed:0.2 green:0.4 blue:0.7 alpha:0.7];
}
...
- (void)setSelectedSegmentIndex:(NSInteger)selectedSegmentIndex
{
    ...
    if (_bFirst) {
        [self._selectedStainView setHidden:YES];
        _bFirst = NO;
    }else {
        [self._selectedStainView setHidden:NO];
    }
