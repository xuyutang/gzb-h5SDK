...
- (void)initTheInterface
{
    ...
    CGRect textViewFrame = CGRectMake(0, 32.0f, xWidth, self.bounds.size.height-32.0f);
...
- (void)refreshTheUserInterface
{
    ...
    {
        self.textView.frame = CGRectMake(0, 32.0f, self.textView.frame.size.width, self.textView.frame.size.height - ZSYCustomButtonHeight);
    }
...
- (void)setCancelButtonTitle:(NSString *)aTitle block:(PopInputViewButtonBlock)block
{
    if (nil == _cancelButton)
    {
        ...
        [self.cancelButton setBackgroundImage:[PopInputView cancelButtonBackgroundImage] forState:UIControlStateNormal];
...
- (void)setDoneButtonWithTitle:(NSString *)aTitle block:(PopInputViewButtonBlock)block
{
    if (nil == _doneButton)
    {
        ...
        [self.doneButton setBackgroundImage:[PopInputView normalButtonBackgroundImage] forState:UIControlStateNormal];
...
- (void)buttonWasPressed:(id)sender
{
    ...
    PopInputViewButtonBlock __block block;
