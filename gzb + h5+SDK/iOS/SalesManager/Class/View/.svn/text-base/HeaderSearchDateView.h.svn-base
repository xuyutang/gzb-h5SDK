...
@protocol HeaderSearchDateViewDelegate <NSObject>
...
@interface HeaderSearchDateView : UIView
...
@property(nonatomic,assign) id<HeaderSearchDateViewDelegate> delegate;
@end
