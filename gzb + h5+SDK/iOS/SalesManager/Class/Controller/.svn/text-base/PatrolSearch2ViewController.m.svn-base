...
@interface PatrolSearch2ViewController ()<DepartmentViewControllerDelegate>{
...
@implementation PatrolSearch2ViewController
@synthesize delegate;
...
{
    [super viewDidLoad];
    leftImageView.image = [UIImage imageNamed:@"ab_icon_back"];	tableView = [[UITableView alloc] initWithFrame:CGRectMake(0, 15, 320, 300) style:UITableViewStyleGrouped];
    ...
    PatrolCategory_Builder* pc = [PatrolCategory builder];
    
    [pc setId:0];
    [pc setName:@"全部"];

    currentPatrolCategory = [[pc build] retain];
...
-(void)toSearch{
    ...
    [bs setCategory:currentPatrolCategory];
