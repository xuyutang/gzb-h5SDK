//
//  GiftPurchaseSearchViewController.m
//  SalesManager
//
...
@interface GiftPurchaseSearchViewController ()

@end

@implementation GiftPurchaseSearchViewController
@synthesize delegate;
...
-(CGFloat)tableView:(UITableView *)tableView heightForRowAtIndexPath:(NSIndexPath *)indexPath{
    //if(indexPath.row == 1 && ![LOCALMANAGER hasFunction:FUNC_APPROVE_DES])return 0;
    return 40;
}
