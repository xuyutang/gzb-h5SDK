...
static void on_message(struct mosquitto *mosq, void *obj, const struct mosquitto_message *message)
{
    ...
    SessionResponse* cr = [SessionResponse parseFromData:data];
    [[client delegate] didReceiveMessage:cr];
}
...
-(void) connectToHost:(NSString *)_host
    ...
    [self setKeepAlive:_keepAlive];
    [self setCleanSession:_cleanSession];
