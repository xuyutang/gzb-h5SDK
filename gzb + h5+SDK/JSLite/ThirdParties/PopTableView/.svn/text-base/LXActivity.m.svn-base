...
@synthesize backGroundView,actionTitle,LXActivityHeight,delegate;
...
- (id)initWithTitle:(NSString *)title delegate:(id<LXActivityDelegate>)_delegate
{
    self = [super init];
    if (self) {
        //初始化背景视图，添加手势
...
- (void)creatView
{
    ...
    [self addSubview:self.backGroundView];
        ...
        UIButton *cancelButton = [self creatCancelButtonWith:@"提交"];
