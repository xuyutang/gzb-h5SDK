...
+ (void)showPopoverAtPoint:(CGPoint)point inView:(UIView *)view withContentView:(UIView *)cView
{
    ...
    [popView showPopoverAtPoint2:point inView:view withContentView:cView];
}

- (void)showPopoverAtPoint2:(CGPoint)point inView:(UIView *)view withContentView:(UIView *)cView
{
