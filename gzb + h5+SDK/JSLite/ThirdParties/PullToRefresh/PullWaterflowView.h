...
@class PullWaterflowView;
@protocol PullWaterflowViewDelegate <NSObject>
...
@interface PullWaterflowView : TMQuiltView<EGORefreshTableHeaderDelegate, LoadMoreTableFooterDelegate>{
    ...
    // Delegate
    id<PullWaterflowViewDelegate> pullDelegate;
...
/* Delegate */
@property (nonatomic, assign) IBOutlet id<PullWaterflowViewDelegate> pullDelegate;
